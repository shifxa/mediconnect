...
function Footer() {
    return (
       <section id="footer" className="w-full mx-auto bg-blue-100 mt-12 rounded-t-4xl">
       ...
       <div id="main" className="flex flex-row gap-x-25 text-start">
         <div id="about" className="flex flex-col gap-y-4 text-justify">
            <h1 className="geist-bold text-3xl hover:text-blue-700
            ">About us</h1>
        ...
        <div id="navigate" className="flex flex-col gap-y-3">
            <h1 className="geist-bold text-xl hover:text-blue-700 ">Navigate</h1>
            <p className="text-gray-900">Home</p>
            <p className="text-gray-900">Specialities</p>
            <p className="text-gray-900">Contact us</p>
        </div>
        <div id="contact" className="flex flex-col gap-y-5">
                <h1 className="geist-bold text-xl hover:text-blue-700">Contact</h1>
        ...
        <div id="follow" className="flex flex-col gap-y-3">
            <h1 className="geist-bold text-xl hover:text-blue-700">Follow us</h1>
        ...
        <div id="copyright" className="flex flex-row gap-x-4 justify-between pt-8 mt-10">
            <span className="flex flex-row">
                <Copyright  size={20}/>
         <p>Copyright <span className="text-blue-500 ">mediconnect.com</span> All rights reserved 2025</p>
            </span>
