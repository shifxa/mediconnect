  ...
  return (
    <section className="w-full mx-auto py-15 bg-gray-100 rounded-3xl ">
      <div id="container" className="flex flex-row gap-x-12">
        <div id="text" className="flex flex-col gap-y-4  w-[40%] pl-6">
          ...
          <p className="geist-semi-bold text-base text-gray-600">
            Your details will be passed along to a scheduling <br />specialist who
        ...
        <div id="right" className="flex flex-col justify-between">
          ...
          <div id="formtext" className="pt-6 pr-6 flex flex-row justify-between w-full ">
            <p className="geist-semi-bold text-base text-gray-600 w-[65%]">
              Your privacy is our priority. We will only gather  your information
              with your clear and explicit consent.
            </p>
            <button type="submit" className="bg-blue-600 py-3 px-6 rounded-4xl geist-semi-bold text-white flex flex-row gap-x-2 h-fit cursor-pointer hover:bg-blue-500"><BriefcaseMedical />Get Appointment</button>
          </div>
        </div>
      </div>
    </section>
